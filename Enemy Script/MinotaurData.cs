...
[System.Serializable]
public class MinotaurData : MonoBehaviour
{
    ...
    public float damageMultiMino = 1.25f;
    public float hitCountKick = 1;
    public float attackRangeKick = 2.75f;
    public float attackCooldownKick = 7.5f;
}
